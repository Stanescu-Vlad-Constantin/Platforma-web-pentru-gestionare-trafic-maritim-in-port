...
(10, 2, 'Doctor', 'Park', 'Minji', 11, 'Coreeană', '1983-12-10', '+42 10-9876-5432', 'Feminin'),
...
(11, 11, 'Pașaport', '114567891', 'Ministerie van Buitenlandse Zaken', '2017-12-17', '2027-12-17'),
...
(16, 16, 'Pașaport', '456789002', 'Bundesministerium des Innern', '2018-07-05', '2028-07-05'),
...
(8, 8, 'Certificat de bucătar', '120456', 'Autoritatea Maritimă Indiană', '2018-07-20', '2023-07-20'),
...
(13, 13, 'Certificat de navigator', '719012', 'Autoritatea Maritimă Chineză', '2018-04-28', '2023-04-28'),
(14, 14, 'Certificat de medic', '012345', 'Autoritatea Maritimă Indiană', '2016-04-14', '2021-04-14'),
(15, 15, 'Certificat de maistru', '134567', 'Autoritatea Maritimă Spaniolă', '2020-11-20', '2025-11-20'),
...
CREATE TABLE tblEscalaVase (
	...
	REFERENCES tblVaseAsteptate (id_Vas_nou) ON DELETE NO OPTION ON UPDATE CASCADE,
	CONSTRAINT fk_id_PortEscala FOREIGN KEY(id_Port_escala) 
	REFERENCES tblPorturi (id_Port) ON DELETE NO OPTION ON UPDATE CASCADE
);
